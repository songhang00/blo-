...
?>
	<div id="member_main">
		...
		<table cellspacing="1">
			...
			?>
			<tr><td><?php echo $_html['fromuser']?></td><td><img src="images/x4.gif" alt="花朵" /> x <?php echo $_html['flower']?>朵</td><td><?php echo $_html['content']?></td><td><?php echo $_html['date']?></td><td><input name="ids[]" value="<?php echo $_html['id']?>" type="checkbox" /></td></tr>
			<?php 
				}
