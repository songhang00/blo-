		...
		<table cellspacing="1">
			...
			<?php 
					...
					while (!!$_rows = _fetch_array_list($_result)) {
						...
						$_html = _html($_html);
			?>
			<tr><td><?php echo $_html['id']?></td><td><?php echo $_html['username']?></td><td><?php echo $_html['email']?></td><td><?php echo $_html['reg_time']?></td>
			<td>
			
			[<a href="?action=mod&id=<?php echo $_html['id']?>">改</a>]</td>
			</tr>
			<?php }?>
			</table>
		</form>
